        ...
        body: SingleChildScrollView(
          child: Column(children: [
            Container(
              ...
              child: Padding(
                padding:
                    const EdgeInsets.only(top: 24.0, left: 24, right: 23.0),
                child: Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      child: TextView('Completed'),
                      onTap: (() {}),
                    ),
                    InkWell(
                      child: TextView('Canceled'),
                      onTap: (() {}),
                    ),
                  ],
                ),
