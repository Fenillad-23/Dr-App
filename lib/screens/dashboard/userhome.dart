          ...
          child:
            ...
            Padding(
                ...
                child: Row(children: [
                  Padding(
                      ...
                      child: TextView('Find your health solution!',
                              ...
                              child: Column(children: [
                                Padding(
                                  ...
                                  child: RoundContainer(
                                      70,
                                      70,
                                      controller.imageIcon[index]['img']
                                          .toString(),
                                      () {}),
                                ),
                                Padding(
            ...
            Padding(
                ...
                child: Row(children: [
                  Padding(
                      padding: const EdgeInsets.only(left: 24),
                      child: TextView('Your Recent Doctors',
                          fontSize: 20, fontWeight: FontWeight.w500))
                ])),
            Padding(
